...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header align-items-center d-flex justify-content-center">
                                <h4 class="card-title mb-0 flex-grow-1 text-center">Consent Form</h4>
                                ...
                                <div class="live-preview">
                                    <form id="businessForm" action="classes/consentF.php" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-6">
                                            <input type="email" name="email" class="form-control" id="nameInput" placeholder="Enter your email" value="<?php echo $_SESSION['AdminEmailId']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-lg-3">
                                                <label for="dateInput" class="form-label">Authorization To Perform A Credit Assessment</label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input type="file" name="bank_statement" class="form-control" id="bankStatementInput" placeholder="Choose file">
                                            </div>
    ...
    <iframe src="tnc.php" title="description" style="width: 100%; height: 50px;"></iframe>
</div>
