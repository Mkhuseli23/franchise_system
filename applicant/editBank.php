...
if(isset($_POST['submit'])) {
    ...
    $update_query = "UPDATE bank_details SET account_name='$account_name', bank_institution='$bank_institution', account_number='$account_number', branch_name='$branch_name', branch_number='$branch_number' WHERE bank_details_id=bank_details_id ";
...
<body>
   ...
   <?php
    $query = mysqli_query($con, "SELECT * FROM bank_details  
    ...
    <div class="main-content" style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0;">
            ...
            <div class="col-xxl-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex justify-content-center">
                        <h4 class="card-title mb-0 flex-grow-1 text-center">Update Bank Account Details</h4>
        ...
        <fieldset>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6">
                <input type="text" name="account_name" class="form-control" id="account_name" placeholder="Enter your account name" value="<?php echo isset($row['account_name']) ? htmlentities($row['account_name']) : ''; ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6">
                <input type="text" name="bank_institution" class="form-control" id="account_name" placeholder="Enter your bank institution" value="<?php echo isset($row['bank_institution']) ? htmlentities($row['bank_institution']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6">
                <input type="text" name="account_number" class="form-control" id="account_number" placeholder="Enter your account number" value="<?php echo isset($row['account_number']) ? htmlentities($row['account_number']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6">
                <input type="text" name="branch_name" class="form-control" id="branch_name" placeholder="Enter your branch name" value="<?php echo isset($row['branch_name']) ? htmlentities($row['branch_name']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6">
                <input type="text" name="branch_number" class="form-control" id="branch_number" placeholder="Enter your branch number" value="<?php echo isset($row['branch_number']) ? htmlentities($row['branch_number']) : ''; ?>">
                </div>
            </div>
