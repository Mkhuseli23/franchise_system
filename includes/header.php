...
<!-- Mirrored from themesbrand.com/velzon/html/default/dashboard-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Feb 2023 21:16:09 GMT -->
<head>
...
session_start(); echo "Welcome, " . $_SESSION['NAME'] . " " . $_SESSION['SURNAME'] . "!"; ?></span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header"> <?php echo " " . $_SESSION['role'] . " " . $_SESSION['roles'] . "!"; ?></h6>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/dashboard-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Feb 2023 21:17:56 GMT -->
</html>